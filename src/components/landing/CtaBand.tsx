      ...
      <div style={{ position: "relative", borderRadius: 32, overflow: "hidden", background: "var(--grad)", padding: "64px 56px", textAlign: "center", color: "var(--acc-ink)" }}>
        ...
        <div style={{ position: "relative" }}>
          <h2 className="ab-h1 ab-cta-title" style={{ fontSize: 46, color: "var(--acc-ink)" }}>
            Your next best-selling listing<br />starts with one photo.
          </h2>
          <div style={{ display: "flex", gap: 12, justifyContent: "center", marginTop: 32, flexWrap: "wrap" }}>
            ...
            <Link href="/dashboard" className="ab-btn ab-btn-lg" style={{ background: "oklch(0 0 0 / 0.12)", color: "var(--acc-ink)", border: "1px solid oklch(0 0 0 / 0.2)" }}>Book a demo</Link>
          </div>
        </div>
      </div>
    </Section>
